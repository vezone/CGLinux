...
int
opengl_context_init(void (*gladLoadProc)(const char* procnName))
{
    int openGLLoadStatus = gladLoadGLLoader((GLADloadproc)gladLoadProc);
...
void
opengl_error_callback(GLenum source, GLenum error, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam)
{
