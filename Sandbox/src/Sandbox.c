...
#define KENNY_BASE_PACK "Sandbox/assets/textures/full_packs/kenney_assets_forest/foliagePack_"
...
//Textures
const char* shader_batched_texture_path = "Sandbox/assets/batched_texture_shader.glsl";
const char* texture_anime_chibi = "Sandbox/assets/anime_chibi.png";
const char* texture_cherno_hazel_logo = "Sandbox/assets/hazel.png";
const char* texture_hotline_miami = "Sandbox/assets/textures/other/hotline_miami.png";
const char* white_texture_path = "Sandbox/assets/textures/default/white_texture.png";

const char* shader_srcs = "Sandbox/assets/simple_rotation_color_shader.glsl";
const char* shader_scs = "Sandbox/assets/simple_color_shader.glsl";
const char* shader_ss = "Sandbox/assets/simple_shader.glsl";
const char* shader_sts = "Sandbox/assets/simple_texture_shader.glsl";
