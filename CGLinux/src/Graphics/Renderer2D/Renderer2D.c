...
void
renderer_batch_init(Renderer2DStatistics* statistics, Shader* shader, OrthographicCamera* camera)
{
    VertexBuffer vbo = {};
    IndexBuffer ibo = {};
    ...
    whiteTexture =  graphics_texture2d_create("CGLinux/resource/assets/textures/default/white_texture.png");
